...
import { Trophy, Coins, Crown, Medal, Loader2, TrendingUp } from 'lucide-vue-next'
        ...
        >
          ...
          <div class="p-0 flex-1">
            <ul class="divide-y divide-slate-100">
              <li
                v-for="(player, index) in store.topVictories"
                :key="player.id"
              ...
              >
                ...
                <div class="text-right">
                  ...
                  <div class="text-xs font-medium text-slate-500 uppercase">Victories</div>
                </div>
              </li>
            </ul>
            ...
            <ul class="divide-y divide-slate-100">
              ...
              >
                ...
                <div class="text-right">
                  ...
                  <div class="text-xs font-medium text-slate-500 uppercase">Coins</div>
                </div>
              </li>
            </ul>
